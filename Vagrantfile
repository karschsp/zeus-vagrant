...
# Create a public network, whi  config.vm.network :forwarded_port, guest: 80,
  # host: 8888, auto_correct: true
  # config.vm.network :private_network, ip: "192.168.51.50"
  # config.ssh.forward_agent = truech generally matched to bridged network.
